...
function lookup(ident, env$$1) {
  var func = evaluate(env$$1.bindings[ident], env$$1);
  return func;
}
...
riot$1.tag2('test', '<input ref="input" type="text"> </input> <button onclick="{evaluate}"> Evaluate it </button>', '', '', function(opts) {
